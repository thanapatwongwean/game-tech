...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 31, 2018 at 02:24 PM
...
INSERT INTO `orders` (`orderid`, `date`, `status`, `username`) VALUES
(1, '2018-12-27 18:02:01', 'received', 'admin'),
(2, '2018-12-28 09:45:10', 'cancelled', 'admin'),
(3, '2018-12-27 18:02:01', 'preparing', 'admin');
...
(6, '64GB ( 16GBx4 ) DDR4/3200 RAM PC (แรมพีซี) CORSAIR DOMINATOR PLATINUM ( CMD64GX4M4C3200C16 )', 32900, 1, 'CPU', 'Type DDR4\r\nSpeed 3200 MHz\r\nTotal Capacity 64 GB\r\nCapacity Per DIMM 16 GB\r\nNumber Of DIMMs 4 DIMM(s)\r\nLatency 16-18-18', 'CORSAIR_DOMINATOR.jpg'),
(7, '2GB ( 2GBx1 , 4 chips ) DDR3/1333 RAM PC (แรมพีซี) KINGSTON VALUE RAM ( KVR13N9S6/2 )', 620, 6, 'CPU', 'Type DDR3\r\nSpeed 1333 MHz\r\nTotal Capacity 2 GB\r\nCapacity Per DIMM 2 GB\r\nNumber Of DIMMs 1 DIMM(s)\r\nLatency 9-9-9', 'Kingston_value.jpg'),
...
CREATE TABLE `user` (
  `username` varchar(20) CHARACTER SET utf8 COLLATE utf8_thai_520_w2 NOT NULL,
  `password` varchar(255) COLLATE utf8mb4_thai_520_w2 NOT NULL,
  `fullname` varchar(255) CHARACTER SET utf8 COLLATE utf8_thai_520_w2 NOT NULL,
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_thai_520_w2 NOT NULL,
  `phone` varchar(10) COLLATE utf8mb4_thai_520_w2 DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_thai_520_w2 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_thai_520_w2;
...
('admin', '$2y$10$XjQQ102ofv/SzlH610ML5.YHjBPfrA/ebA/DRw1rYQgf4F1c1nxCS', 'admin', '1112 place', '', 'admin@game-tech.com'),
('tw_Earth', '$2y$10$ZQQjTu7H4JwY1x.7Lby.PO9LIPYY8l1bYQHj0dlnE0Uh6e7CTvUdu', 'thanapat wongwean', '522 OP', '0957453025', 'thanapatwongwean@gmail.com'),
('user', '$2y$10$bVnrYoARSpTrIib6mp816OrtA1pYA2Xny9sGhSJr6iDzIf1yGdH/S', 'user', '1112', '1112', 'user@game-tech.com');
